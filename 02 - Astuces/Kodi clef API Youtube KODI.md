...
Voici un exemple de document d'ID "clef api youtube.txt"
...
API code secret :
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
...
- Dans "Sélectionner une API" il faut avoir choisi "YouTube Data API v3" et choisissez l'option "Données publiques" et cliquez sur "Suivant"
...
- Sur la page suivante (Utilisateurs tests) allez en bas et cliquez sur "Enregistrer et continuer"
...
- dans un popup apparait votre "ID client" et votre "code secret du client", copiez les dans votre "clef api youtube.txt".

4 - Rentrez les clefs dans Kodi
