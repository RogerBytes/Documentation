...
# 3. Récupération de la liste des runners disponibles, triés par ordre alphabétique
...
# 4. Demande facultative pour personnaliser le taux de compression (identique au packer de jeux)
LEVEL=3
